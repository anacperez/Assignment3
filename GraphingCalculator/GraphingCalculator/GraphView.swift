...
class GraphingView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let ad = AxesDrawer(color: axesColor, contentScaleFactor: contentScaleFactor)
        ad.drawAxesInRect(bounds: bounds, origin: graphCenter, pointsPerUnit: pointsPerUnit*scale)
        let bezierPath = UIBezierPath()
        
        if var plots = dataSource?.graphPlot(sender: self), plots.first != nil {
